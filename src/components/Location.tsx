...
const Location = () => {
  const openDirections = () => {
    window.open("https://www.google.com/maps/dir/?api=1&destination=88+SE+75th+St,+Starke,+FL+32091", "_blank");
  };
...
<div className="space-y-8">
  <Card className="overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm">
    <div className="h-96 w-full">
      <iframe
        src="https://www.google.com/maps?q=88+SE+75th+St,+Starke,+FL+32091&output=embed"
        width="100%"
        height="384"
        style={{ border: 0 }}
        allowFullScreen=""
      ...
      ></iframe>
              ...
              <Card className="p-8 border-border/50 bg-card/80 backdrop-blur-sm">
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <p>• There is an Exxon station right before the location with good beverage and snack optons</p>
