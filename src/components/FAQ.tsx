  ...
  const faqs = [
    {
      ...
      answer: "Pack comfortable outdoor clothing, hiking shoes, swimwear, sunscreen, and any personal items you need. Bedding and meals are provided. Don't forget your sense of adventure!"
    },
    {
